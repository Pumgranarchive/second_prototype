...
val build_ck_tags_list: (string * string) list -> Html5_types.input Eliom_content.Html5.F.elt list * Html5_types.div Eliom_content.Html5.F.elt list

(** Build the tags html formular from tag list *)
val build_tags_form: (string * string) list -> Html5_types.input Eliom_content.Html5.F.elt * Html5_types.input Eliom_content.Html5.F.elt list * [ > Html5_types.div ] Eliom_content.Html5.F.elt list
