...
val content_detail: (string * string * string) * (string * string) list * (string * string * string) list * (string * string) list -> Html5_types.html Eliom_content.Html5.elt

(** Update content detail html service *)
val content_update: (string * string * string) * (string * string) list * (string * string * string) list * (string * string) list -> Html5_types.html Eliom_content.Html5.elt
